...
const SideBar = ({ selected, setSelected, setDarkMode, darkMode }) => {
  ...
  const chatPreferences = [
    ...
    //         strokeLinejoin='round'
    //         strokeWidth={2}
    //         d='M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994
    //  1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2
    // 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z'
    //       />
    //     </svg>
    //   ),
    //   onClick: '',
  ...
  return (
    <div className='bg-white-pure dark:bg-dark-pure flex flex-col items-center max-w-[4.5rem] min-w-[4.5rem] justify-between p-2 h-screen shadow-md z-10 text-gray-base'>
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <div className='w-14 h-14 cursor-pointer flex justify-center items-center rounded hover:bg-gray-light dark:hover:bg-dark-gray  group relative duration-300'>
